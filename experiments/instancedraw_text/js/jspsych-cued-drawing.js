  ...
  plugin.trial = function(display_element, trial) {    
    ...
    function show_cue() {    
      ...
      if (trial.practiceTrial === true) {
        html += '<div id="occluder"><p style="padding-top: 250px;padding-bottom: 300px;">Visualize a specific <b>FACE</b>!</p>'//'<div id="occluder"><p style="padding-top: 200px;padding-bottom: 300px;">This is a practice trial! Before each trial, you will be asked to visualize an object<br><br>In this case, visualize anything you want! <br><br> If the layout looks off, please resize your browser accordingly!</p> </div>'
      } else if (trial.category === "bread") {
        html += '<div id="occluder"><p style="padding-top: 250px;padding-bottom: 300px;">Visualize a specific piece of <b>'+ trial.category.toUpperCase()+ '</b>!</p>'
      } else {
        //a_or_an = ['a','e','i','o','u'].includes(trial.category[0])      + (a_or_an ? 'an <b>' : 'a <b>')
        html += '<div id="occluder"><p style="padding-top: 250px;padding-bottom: 300px;">Visualize a specific <b>' + (trial.category === 'car_(sedan)' ? 'car (sedan)' : trial.category).toUpperCase() + '</b>!</p>'
      }
